        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <Card className="w-full max-w-md">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription>
                Please check your email to verify your account. Once verified, an administrator will review and activate your access.
              </CardDescription>
            </CardHeader>
            <CardFooter>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Register for access to the Traffic Surveillance System
            </CardDescription>
          </CardHeader>
